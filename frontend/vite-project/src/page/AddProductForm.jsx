...
function AddProductForm() {
  ...
  return <div className="flex">
    <Sidebar/>
    <div className="flex justify-center ml-[500px] mt-20 items-center  bg-yellow-50">
      <form 
        onSubmit={handleSubmit} 
        className="bg-white shadow-lg rounded-lg p-8 w-[800px] max-w-md"
      >
        <h2 className="text-2xl font-bold text-yellow-600 mb-6 text-center">Add New Product</h2>
