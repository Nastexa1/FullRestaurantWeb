  ...
  return (
    <div className="bg-yellow-50 pt-20 p-3 md:flex md:gap-5">
      ...
      <div className="flex flex-col gap-5 md:w-72">
        {/* Categories */}
        <div>
          <h1 className="text-yellow-600 text-2xl font-bold border-b-2 border-gray-300">Categories</h1>
        ...
        {/* New Products */}
        <div>
          <h1 className="text-yellow-600 text-2xl font-bold border-b-2 border-gray-300">New Products</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
          {filteredItems.map((item) => (
            <div key={item._id} className="bg-white rounded shadow p-5 flex flex-col">
              <img className="rounded w-full h-40 object-cover" src={item.image} alt={item.Name} />
